package com.example.yujihu.musicplayerdemo.http;
...
import com.example.yujihu.musicplayerdemo.common.AppContext;
...
public class HttpClient {
    ...
    private static final String HTTP_DOMAIN = "music/music.json";
    public static void getSongs(HttpResponseHandler httpResponseHandler) {
        get(HTTP_DOMAIN, null, httpResponseHandler);
    }
    //*************************************************************//
}
